...
<div class="single-product-area">
        ...
        <br><br>
          <table class="table table-hover">
            ...
            $res = new Rsolicitacao();
            $nada = $res->MostrarSolicitacoes($_SESSION['usuario']['id']);
            while($p =  $nada->fetch(PDO::FETCH_ASSOC)){
            ?>
              <tr>
                <th scope="row"><?php echo $p['id']; ?></th>
                <td><a href="signEmpresa?idA=<?php echo $p['idAnucio']; ?>"><?php echo $p['nome']." ".$p['subnome']; ?></a></td>
                <td><?php echo $p['email']?></td>
                <td><?php echo $p['telefone']?></td>
                <td><?php echo $p['localizacao']?></td>
                <td><?php echo $p['categoria']?></td>
                <td><?php echo $p['data']?></td> 
                <form action="deletarSolicitacaoProfissional" method="post">
                <td><button name="idP" value="<?php echo $p['id']; ?>" type="submit" class="btn btn-danger" >Deletar</button></td>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
            <li><a class="nav-link scrollto active" href="./public/#hero">Inicio</a></li>
          <li><a class="nav-link scrollto" href="./public/#about">Sobre</a></li>
          <li><a class="nav-link scrollto" href="./public/#services">Serviços</a></li>
          <li><a class="nav-link scrollto" href="./public/#portfolio">Portfolio</a></li>
          <li><a class="nav-link scrollto" href="./public/#team">Equipa</a></li>
