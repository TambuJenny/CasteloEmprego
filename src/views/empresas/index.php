                ...
                <div class="col-md-3 col-sm-6">
                    <div class="single-shop-product">
                        <div class="product-upper">
                            <img style="width: 120px; height:80px; border-radius: 40px;" src="./public/assets/Job2.png" alt="">
                        </div>
                        <h2 ><a style="text-decoration: none; color:darkgoldenrod; font-family:'Times New Roman', Times, serif" href="signEmpresa?idA=<?php echo $p['idA'] ?>"><?php echo $p['titulo'];?></a></h2>
                        <div class="product-carousel-price">
                            <ins><?php echo $p['areaActuacao'];?></ins>
                        </div>  
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="empresas"><span>Anucios</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li class="dropdown"><a href="profissionais"><span>Anuacios de profissionais</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <li><a href="profisionais">T.I</a></li>
                  <li><a href="profisionais">Contabilidade</a></li>
                  <li><a href="profisionais">Saúde</a></li>
                  <li><a href="profisionais">Mecânica</a></li>
                  <li><a href="profisionais">Outras</a></li>
  ...
  <footer id="footer">
    ...
    <div class="container">
      ...
      <div class="credits">
        ...
        Feito por <a href="signEmpresa">WEBIN</a>
      </div>
    </div>
  </footer><!-- End Footer -->
