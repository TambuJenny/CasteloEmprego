...
<head>
  ...
  <title>Profissionais Aderidos</title>
 ...
 <table class="table table-hover">
  <thead>
    <tr>
      ...
      <th scope="col">Actuação</th>
      <th scope="col">Contactos</th>
      <th scope="col">Email</th>
      <th scope="col">IdAnucio</th>
      <th scope="col"></th>
    </tr>
  </thead>
  <tbody>
  <?php 
           ...
           $res = new RAdesao();
           $nada = $res->MostrarAdesoes($_SESSION['usuario']['id']);
           while($p =  $nada->fetch(PDO::FETCH_ASSOC)){
           ?>
             <tr>
               <th scope="row"><?php echo $p['id']; ?></th>
               <td><a href="signProfissional?idP=<?php echo $p['idP']; ?>"><?php echo $p['nome']." ".$p['subnome']; ?></a></td>
               <td><?php echo $p['categoria']?></td>
               <td><?php echo $p['telefone']?></td>
               <td><?php echo $p['email']?></td>
               <td><?php echo $p['idAnucio']?></td>
